            ...
            <form method="GET" action="{{ route("admin.pemesanans.index") }}" class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    ...
                    <select name="bukti" class="form-select">
                        ...
                        <option value="sudah" {{ request("bukti") == "sudah" ? "selected" : "" }}>Sudah Upload</option>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if(!\$pemesanan->data_completed_at)
                                    <div class="mt-1"><span class="badge" style="background-color: #f1c40f; color: #000; font-size: 0.7rem;"><i class="fas fa-exclamation-triangle"></i> Biodata Kosong</span></div>
                                @else
                                    <div class="mt-1"><span class="badge" style="background-color: #2ecc71; font-size: 0.7rem;"><i class="fas fa-check-circle"></i> Biodata Lengkap</span></div>
                                @endif
                            </td>
                            <td>
                            ...
                            <td>
                                @if(\$pemesanan->bukti_pembayaran)
                                    <span class="badge rounded-pill" style="background-color: #2ecc71; padding: 5px 10px; font-weight: 500;">Sudah</span>
                                @else
                                    <span class="badge rounded-pill" style="background-color: #e74c3c; padding: 5px 10px; font-weight: 500;">Belum</span>
                                @endif
                            </td>
                            <td>
                                @if(\$pemesanan->status == "pending")
                                    <span class="badge rounded-pill" style="background-color: #f1c40f; color: #000; padding: 5px 10px; font-weight: 500;">Menunggu</span>
                                @elseif(\$pemesanan->status == "paid")
                                    <span class="badge rounded-pill" style="background-color: #00d2d3; padding: 5px 10px; font-weight: 500;">Dikonfirmasi</span>
                                @elseif(\$pemesanan->status == "failed")
                                    <span class="badge rounded-pill" style="background-color: #e74c3c; padding: 5px 10px; font-weight: 500;">Dibatalkan</span>
                                @endif
                            </td>
...
@endsection
EOF;
file_put_contents("resources/views/admin/pemesanans/index.blade.php", $content);
echo "Pemesanans premium layout implemented\n";
