...
Sistem Travel Umroh Travelkartika Mas adalah platform web untuk mengelola pemesanan paket umroh dengan fitur:
- **Area Publik**: Browsing paket umroh
- **Area Member**: Registrasi, login, booking paket, melihat status pemesanan
- **Area Admin**: Dashboard, verifikasi pemesanan, input informasi keberangkatan
...
- Lihat paket-paket umroh yang tersedia
...
5. **Payment**: Fitur pembayaran belum diimplementasikan (baru display harga)
...
4. Submit pemesanan → Status: PENDING
        ↓
5. Admin verifikasi & input info keberangkatan
        ↓
6. Status berubah: CONFIRMED
        ↓
7. Jamaah bisa lihat info keberangkatan
        ↓
8. Jamaah berkumpul di lokasi & waktu yang ditentukan
        ↓
9. Berangkat ke tanah suci! ✈️
```
...
*Panduan ini dibuat untuk memudahkan penggunaan sistem Travelkartika Mas.*
